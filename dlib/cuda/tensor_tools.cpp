...
// ----------------------------------------------------------------------------------------
	...
	{
#ifdef DLIB_USE_CUDA
		cuda::leakyrelu(dest, src, param);
#else
		cpu::leakyrelu(dest, src, param);
#endif
	}
	...
	{
#ifdef DLIB_USE_CUDA
		cuda::leakyrelu_gradient(grad, src, gradient_input, param, params_grad);
#else
		cpu::leakyrelu_gradient(grad, src, gradient_input, param, params_grad);
#endif
	}
