...
// ----------------------------------------------------------------------------------------
	...
	class loss_binary_cross_entropy_htan_
	{
	public:
			...
			) const
		{
			...
			for (long i = 0; i < output_tensor.num_samples(); ++i)
			{
				...
				if(i== output_tensor.num_samples()-1)
							cout << "label" << y << ", grad:" << g[i] << " ,loss :" << loss << " ,io:" << io[i] << ",out:" << out_data[i] << endl;
		...
		friend void serialize(const loss_binary_cross_entropy_htan_&, std::ostream& out)
		{
			serialize("loss_binary_cross_entropy_htan_", out);
		}

		friend void deserialize(loss_binary_cross_entropy_htan_&, std::istream& in)
		{
			std::string version;
			deserialize(version, in);
			if (version != "loss_binary_cross_entropy_htan_")
				throw serialization_error("Unexpected version found while deserializing dlib::loss_binary_log_.");
		}

		friend std::ostream& operator<<(std::ostream& out, const loss_binary_cross_entropy_htan_&)
		{
			out << "loss_binary_cross_entropy_htan_";
			return out;
		}

		friend void to_xml(const loss_binary_cross_entropy_htan_& /*item*/, std::ostream& out)
		{
			out << "<loss_binary_cross_entropy_htan_/>";
		}
	...
	template <typename SUBNET>
	using loss_binary_cross_entropy_htan = add_loss_layer<loss_binary_cross_entropy_htan_, SUBNET>;

	class loss_binary_cross_entropy_
	{
	public:
		...
		{
			serialize("loss_binary_cross_entropy_", out);
		}

		friend void deserialize(loss_binary_cross_entropy_&, std::istream& in)
		{
			std::string version;
			deserialize(version, in);
			if (version != "loss_binary_cross_entropy_")
				throw serialization_error("Unexpected version found while deserializing dlib::loss_binary_log_.");
		}

		friend std::ostream& operator<<(std::ostream& out, const loss_binary_cross_entropy_&)
		{
			out << "loss_binary_cross_entropy_";
			return out;
		}

		friend void to_xml(const loss_binary_cross_entropy_& /*item*/, std::ostream& out)
		{
			out << "<loss_binary_cross_entropy_/>";
		}
	...
	template <typename SUBNET>
	using loss_binary_cross_entropy = add_loss_layer<loss_binary_cross_entropy_, SUBNET>;
...
//-------------------------------------------------------------------------------------------
	...
	public:
		...
		friend void serialize(const loss_binary_log_nosig_&, std::ostream& out)
		{
			serialize("loss_binary_log_nosig_", out);
		}

		friend void deserialize(loss_binary_log_nosig_&, std::istream& in)
		{
			std::string version;
			deserialize(version, in);
			if (version != "loss_binary_log_nosig_")
				throw serialization_error("Unexpected version found while deserializing dlib::loss_binary_log_.");
		}

		friend std::ostream& operator<<(std::ostream& out, const loss_binary_log_nosig_&)
		{
			out << "loss_binary_log_nosig";
			return out;
		}

		friend void to_xml(const loss_binary_log_nosig_& /*item*/, std::ostream& out)
		{
			out << "<loss_binary_log_nosig/>";
		}
	...
	template <typename SUBNET>
	using loss_binary_log_nosig = add_loss_layer<loss_binary_log_nosig_, SUBNET>;
